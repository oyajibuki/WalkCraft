...
const RECIPES = [
  ...
  { id: 'i8',  name: 'ガラス',         icon: '🪟', reqLevel: 2, materials: ['m9', 'm24'],  desc: '砂と貝殻を高熱で溶かした透明な素材。',          price: 40   },
  { id: 'i9',  name: '鉄の剣',         icon: '🗡️', reqLevel: 2, materials: ['m4', 'm6'],   desc: '鉄鉱石と火打ち石で鍛えた剣。',                  price: 100  },
  { id: 'i10', name: '回復薬グレート',  icon: '💊', reqLevel: 3, materials: ['m5', 'm13'],  desc: '薬草にハチミツを加えた高性能回復薬。',          price: 80   },
  ...
  { id: 'r2',  name: '木炭',           icon: '⬛', reqLevel: 1, materials: ['r1', 'm6'],   desc: '木の板を焼いて作る燃料',                        price: 15   },
  ...
  { id: 'f8',  name: 'コーラ',         icon: '🥤', reqLevel: 3, materials: ['m13', 'm3'],   desc: '清涼飲料水',                                    price: 35   },
  ...
  // ── 建物・乗り物レシピ b1-b12 ──
  { id: 'b1',  name: '作業台',         icon: '🪚', reqLevel: 1, materials: ['r1', 'm16'],  desc: 'クラフトの基本設備',                            price: 30   },
  { id: 'b2',  name: 'かまど',         icon: '🧱', reqLevel: 1, materials: ['m2', 'm6'],   desc: '鉱石を精錬する炉',                              price: 40   },
  ...
  { id: 'b6',  name: '醸造台',         icon: '⚗️', reqLevel: 3, materials: ['m8', 'm15'],   desc: 'ポーションを作る',                              price: 200  },
  ...
  { id: 'p7',  name: 'クリエイターの証',icon: '🎖️', reqLevel: 4, materials: ['ga10', 'ga14'],desc: '開発者支援の証',                                price: 10000},
...
const BASE_STAGES = [
  ...
  { stage: 4, name: 'レンガの家',       icon: '🏠', phase: 'Phase 2: 開拓村期',        desc: 'レンガを積み上げた頑丈な家。建てるとTier2レシピが全解放される！',        cost: { m8: 15, m10: 10 },        ptCost: 2000 },
  { stage: 5, name: '鉄工所',           icon: '⚙️', phase: 'Phase 2: 開拓村期',        desc: '鉄のインゴットで作った工業施設。機械化の夜明け。',                      cost: { i6: 5, m4: 15 },          ptCost: 3500 },
  { stage: 6, name: '蒸気工場',         icon: '🏭', phase: 'Phase 3: 産業革命期',      desc: '銅線と蒸気が動力を生む。建てるとTier3レシピ解放！産業革命の幕開け！',    cost: { m11: 15, m12: 10 },       ptCost: 5000 },
  { stage: 7, name: '研究施設',         icon: '🏛️', phase: 'Phase 3: 産業革命期',      desc: '魔法の薬と水晶で動く高度な研究拠点。建てるとTier4レシピが解放！',        cost: { i15: 2, m15: 10 },        ptCost: 8000 },
